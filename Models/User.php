...
//methode pour modifier le profil d'un user
public function updateUser() {
$query = 'UPDATE `users` SET `lastname` =:lastname, `firstname` =:firstname, `email` =:email WHERE `id`= :id';
...
print_r($this);
try {
$val = $queryResult->execute();echo"coucou";
} catch (Exception $e) {
    print_r($e);die();
}
...
return $queryResult->execute();
    ...
    public function deleteUser() {
        ...
        $deleteUser = $this->db->prepare($sql);
