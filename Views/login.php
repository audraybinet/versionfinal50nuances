        ...
        <div class="col-md-6 card mb-5">
            ...
            <form class="card-body" method="POST" action="" novalidate="">
                <div class="form-group md-form">
                    ...
                    <input autocomplete="false" name="email" type="text" class="form-control" id="emailLogin" required  <?= $errors['login'] ?? '' ?>>
                </div>
                ...
                <button class="btn btn-info btn-dark" type="submit">Se connecter</button>
            </form>
        </div>
    </div>
</div>
